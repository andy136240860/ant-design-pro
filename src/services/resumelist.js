...
export async function upstatus(params) {
  return request(`/api/operateresume/upstatus/${params.id}`, { method: 'PUT', data: params });
}
...
export async function upcall(params) {
  return request(`/api/operateresume/upcall/${params.id}`, { method: 'PUT', data: params });
}
// 项目重要程度
export async function upimportant(params) {
  return request(`/api/project/upimportant/${params.id}`, { method: 'PUT', data: params });
}
